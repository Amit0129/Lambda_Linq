    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            List<ProductReview> products = new List<ProductReview>()
            {
                ...
                new ProductReview() { ProductID = 11, UserID = 5, Rating = 2, Review = "VeryGood", IsLike = true },
                ...
                new ProductReview() { ProductID = 14, UserID = 2, Rating = 1, Review = "VeryBad", IsLike = true },
                ...
                new ProductReview() { ProductID = 21, UserID = 5, Rating = 2, Review = "VeryGood", IsLike = true },
