    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            List<ProductReview> products = new List<ProductReview>()
            {
                ...
                new ProductReview() { ProductID = 11, UserID = 9, Rating = 2, Review = "VeryGood", IsLike = true },
                ...
                new ProductReview() { ProductID = 14, UserID = 9, Rating = 1, Review = "VeryBad", IsLike = true },
                new ProductReview() { ProductID = 15, UserID = 1, Rating = 2, Review = "Average", IsLike = true },
                ...
                new ProductReview() { ProductID = 20, UserID = 6, Rating = 1, Review = "VeryBad", IsLike = true },
                new ProductReview() { ProductID = 21, UserID = 9, Rating = 2, Review = "VeryGood", IsLike = true },
                new ProductReview() { ProductID = 22, UserID = 4, Rating = 1, Review = "VeryBad", IsLike = true },
